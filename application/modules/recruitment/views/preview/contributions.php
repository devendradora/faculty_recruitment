	...
	if(isset($contributions[$key.'-organization'])){
		...
		<div class="row clearfix">
			...
			<div class="row">
				...
				<!-- Awards and Medals -->
				<?php if(isset($contributions['medals-awarded-name'])): ?>
				<div class="row clearfix">
					<div class="col-md-12 column">
						<h4>
							Awards / Medals awarded <span class="label label-danger"><?php echo sizeof($contributions['medals-awarded-name']); ?></span>
						</h4>
						<table class="table table-bordered">
							<thead>
								<tr>

function phd_SCI_journal_add_row(){
    ...
    var tdsTypes = new Array("number" ,"text" ,"text","text","text","number","text" ,"text","file","hidden");
...
function phd_non_SCI_journal_add_row(){
    ...
    var tdsTypes = new Array("number" ,"text" ,"text","text","text","number","text","file","hidden");
    var tdsRequired = new Array("","","","","","","","");
    var noColumns=9;
